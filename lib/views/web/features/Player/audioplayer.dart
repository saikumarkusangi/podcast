...
class WebPlayer extends ConsumerStatefulWidget {
  final String data;
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _WebPlayerState();
}

class _WebPlayerState extends ConsumerState<WebPlayer> {
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Controller(audioPlayer: _audioPlayer,width: 200,),
                    ],
                  ),
                )
              ],
